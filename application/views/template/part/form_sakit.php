...
<script>
	...
	$("#go_absen").submit(function(){
		...
		$.post("<?php echo base_url()?>index.php/absensi/set_form_sakit/",{FID:FID,NIK:NIK,tanggal:tanggal,keterangan:keterangan},function(e){
			//alert(e);
			
			//$(".content-wrapper").html(e);
			eksekusi_controller('index.php/absensi/data_sakit_by_nik');
		});
