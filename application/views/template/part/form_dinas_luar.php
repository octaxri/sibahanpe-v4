...
<script>
	...
	$("#go_absen").submit(function(){
    	...
    	if(daydiff(tanggal,tanggal_antara) > 5)
        {
        	alert("Perhatikan !!! Pengajuan DL lebih dari 5 hari. Anda mengajukan DL "+daydiff(tanggal,tanggal_antara)+" hari.");
			return false;
        }

		
		
		$.post("<?php echo base_url()?>index.php/absensi/set_form_dinas_luar/",{FID:FID,NIK:NIK,tanggal_antara:tanggal_antara,tanggal:tanggal,keterangan:keterangan},function(e){
			//alert(e);
			
			//$(".content-wrapper").html(e);
			eksekusi_controller('index.php/absensi/data_dinas_luar_by_nik');
		});
