...
<script>
	...
	$("#go_absen").submit(function(){
		...
		$.post("<?php echo base_url()?>index.php/absensi/set_form_cuti_lain/",{FID:FID,NIK:NIK,tanggal:tanggal,keterangan:keterangan},function(e){
			//alert(e);
			
			//$(".content-wrapper").html(e);
			eksekusi_controller('index.php/absensi/data_cuti_lain_by_nik');
		});
